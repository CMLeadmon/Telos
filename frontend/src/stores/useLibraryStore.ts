...
export interface LibraryItem {
  ...
  addedOn?: string;
  // Editable bibliographic metadata. BookManageModal prefills its form from
  // this shape and PUTs the whole form back, so these must round-trip or a
  // save wipes them upstream.
  publisher?: string;
  isbn10?: string;
  isbn13?: string;
  kind: LibraryKind;
